<template>
  <header>
    <van-image width="100" height="100" src="/logo.svg" />
    <h2>戏曲字幕服务中心</h2>
  ...
  <van-row gutter="20">
    ...
    <van-col span="12">
      <div class="x-van-col" @click="toChangDuan">
        <van-icon name="/ic_changci.svg" size="2rem" class="col-icon" />
...
const isOpenAccesibilityService = computed(() => query.item && query.item == 'openAccesibilityService');
